# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 03:29:52 2019
...
dataset = pd.read_csv('D:/Netbiis/Curso_AS/Tweets_Mg.csv',encoding='utf-8')
dataset.count()
...
data_frame.to_csv("D:/Netbiis/Curso_AS/tweets_classificados_por_forest.csv", index = False)
